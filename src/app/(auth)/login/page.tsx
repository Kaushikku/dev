      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes pulse-glow {
          ...
          50% { box-shadow: 0 0 40px #00f5ff88; }
        }
        @keyframes fadeIn {
        ...
        .neon-btn:hover { background: #00f5ff !important; color: #0a0a0f !important; box-shadow: 0 0 30px #00f5ff88 !important; }
      ...
      <div className="auth-card" style={{
        ...
        {tab === 'login' && (
          <form onSubmit={handleLogin}>
            <Input label="Email" type="email" value={loginForm.email}
              onChange={v => setLoginForm(p => ({ ...p, email: v }))} placeholder="you@email.com" />
            <Input label="Password" type="password" value={loginForm.password}
        ...
        {tab === 'signup' && (
          <form onSubmit={handleSignup}>
            <Input label="Username" type="text" value={signupForm.username}
              onChange={v => setSignupForm(p => ({ ...p, username: v }))} placeholder="player123" />
            <Input label="Email" type="email" value={signupForm.email}
              onChange={v => setSignupForm(p => ({ ...p, email: v }))} placeholder="you@email.com" />
            <Input label="Password" type="password" value={signupForm.password}
              onChange={v => setSignupForm(p => ({ ...p, password: v }))} placeholder="Min 8 characters" />
            <Input label="Confirm Password" type="password" value={signupForm.confirm}
